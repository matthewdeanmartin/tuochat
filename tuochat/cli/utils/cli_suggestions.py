...
class SmartParser(argparse.ArgumentParser):
    ...
    def error(self, message: str):
        ...
        # Python 3.15+ argparse may already include "maybe you meant 'X'?" inline;
        # skip our suggestion in that case to avoid duplicating the hint.
        if "invalid choice" in message and "choose from" in message and "maybe you meant" not in message:
